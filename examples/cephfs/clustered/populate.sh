...
IP="${IP:-127.0.0.1}"
PORT="${PORT:-8500}"
CLUSTER_PATH="${CLUSTER_PATH:-ceph-config/${CLUSTER}}"

# auth
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/auth/cephx true
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/auth/cephx_require_signatures false
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/auth/cephx_cluster_require_signatures true
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/auth/cephx_service_require_signatures false

# auth
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/global/max_open_files 131072
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/global/osd_pool_default_pg_num 128
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/global/osd_pool_default_pgp_num 128
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/global/osd_pool_default_size 3
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/global/osd_pool_default_min_size 1

kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/global/mon_osd_full_ratio .95
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/global/mon_osd_nearfull_ratio .85
...
#osd
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/osd/journal_size 1024
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/osd/cluster_network 10.244.0.0/16
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/osd/public_network 10.244.0.0/16
...
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/osd/osd_op_threads 8
...
kviator --kvstore=${KV} --client=${IP}:${PORT} put ${CLUSTER_PATH}/osd/osd_recovery_op_priority 2
