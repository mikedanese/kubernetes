...
func addDefaultingFuncs(scheme *runtime.Scheme) {
	scheme.AddDefaultingFuncs(
		func(obj *KubeProxyConfiguration) {
			...
			if obj.ConntrackTCPEstablishedTimeout == zeroDuration {
		...
		func(obj *KubeletConfiguration) {
			...
			if obj.LockFilePath == nil {
				temp := "/var/run/lock/kubelet.lock"
				obj.LockFilePath = &temp
			}
			...
			if obj.HairpinMode == nil {
				obj.HairpinMode = boolVar(true)
			}
		},
	)
}
